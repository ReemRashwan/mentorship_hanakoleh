...
public enum ErrorCode {
    QUANTITY_REQUIRED("CART_001", QUANTITY_REQUIRED_MESSAGE),
    QUANTITY_MUST_BE_POSITIVE("CART_002", QUANTITY_MUST_BE_POSITIVE_MESSAGE),
    CART_ITEM_NOT_FOUND("CART_003", CART_ITEM_NOT_FOUND_MESSAGE),
    MENU_ITEM_NOT_ORDERABLE("CART_004", MENU_ITEM_NOT_ORDERABLE_MESSAGE),
    MENU_ITEM_INSUFFICIENT_STOCK("CART_005", MENU_ITEM_INSUFFICIENT_STOCK_MESSAGE);
