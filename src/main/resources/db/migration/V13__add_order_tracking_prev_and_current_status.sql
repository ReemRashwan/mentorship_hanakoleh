...
ALTER TABLE order_tracking ADD COLUMN order_current_status  VARCHAR(30) DEFAULT 'CREATED' NOT NULL;
ALTER TABLE order_tracking ADD COLUMN order_previous_status VARCHAR(30);
